...
<?php include "includes/sign-up.php" ?>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="home__content">
              ...
              <!-- Heading -->
              <h1 class="home__heading">Certificates</h1>
    ...
    <section class="section__categories">
    	<div class="container">
    	  <div class="row">
          <?php
          $query = "SELECT * FROM certificate ORDER BY `certificate`.`c_id` DESC ";
          $select_all_certificate = mysqli_query($connection, $query);
          while ($row = mysqli_fetch_assoc($select_all_certificate)) {     
    	  ...
    	  <div class="blog-item__date"><i class="ion-calendar" aria-hidden="true"></i><?php echo $row['date']?></div> 
              ...
              <div class="blog-item__title ">
                    ...
                    <a href="https://svpsadmin.in/images/updates/<?php echo $certificate_image ?>" target=' '>
                        
                        <?php echo $certificate_title; ?></a> 
                </h3>
              </div>
            </div>
    	    </div>
